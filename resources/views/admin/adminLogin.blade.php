    ...
    <div
        ...
        <form class="space-y-6 " method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="flex justify-center mb-6">
                <a href="{{ route('home') }}">
                    <img loading="lazy" src="/storage/logos/LOGO.png" class="h-20" alt="Logo" />
                </a>
            </div>
            <h5 class="mb-6 text-xl font-medium text-gray-900 dark:text-white ">Masuk</h5>
            <div class="mb-6">
            ...
            <button type="submit"
                class="w-full text-white bg-pr-400 hover:bg-pr-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Masuk sebagai Admin</button>
